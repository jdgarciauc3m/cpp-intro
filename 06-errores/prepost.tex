...
\lstinputlisting[lastline=17]{06-errores/prepost/check.cpp}
\ldots
\end{block}
\end{frame}
...
\begin{block}{check.cpp}
\ldots
\lstinputlisting[firstline=19,lastline=31]{06-errores/prepost/check.cpp}
\ldots
\end{block}
\end{frame}
...
\begin{block}{check.cpp}
\ldots
\lstinputlisting[firstline=33]{06-errores/prepost/check.cpp}
\end{block}
\end{frame}
...
\begin{block}{check.cpp}
\lstinputlisting{06-errores/prepost/check.cpp}
\end{block}
\end{frame}
}
...
\mode<presentation>{
\lstinputlisting[firstline=1,lastline=14]{06-errores/prepost/nocheck.cpp}
\ldots
}
\mode<article>{
\lstinputlisting{06-errores/prepost/nocheck.cpp}
}
\end{block}
\end{frame}
...
\begin{block}{nocheck.cpp}
\ldots
\lstinputlisting[firstline=15]{06-errores/prepost/nocheck.cpp}
\end{block}
\end{frame}
}
