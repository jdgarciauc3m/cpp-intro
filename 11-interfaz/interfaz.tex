...
\begin{frame}
\begin{block}{mes.h}
\lstinputlisting[lastline=21]{11-interfaz/fecha7/mes.h}
\end{block}
\end{frame}

\begin{frame}
\begin{block}{mes.h}
\lstinputlisting[firstline=23]{11-interfaz/fecha7/mes.h}
\end{block}
\end{frame}
...
\begin{frame}
\begin{block}{mes.h}
\lstinputlisting{11-interfaz/fecha7/mes.h}
\end{block}
\end{frame}
}
...
\begin{frame}
\begin{block}{mes.cpp}
\lstinputlisting[lastline=13]{11-interfaz/fecha7/mes.cpp}
\end{block}
\end{frame}

\begin{frame}
\begin{block}{mes.cpp}
\lstinputlisting[firstline=15, lastline=23]{11-interfaz/fecha7/mes.cpp}
\end{block}
\end{frame}

\begin{frame}
\begin{block}{mes.cpp}
\lstinputlisting[firstline=25]{11-interfaz/fecha7/mes.cpp}
\end{block}
\end{frame}
...
\begin{frame}
\begin{block}{mes.cpp}
\lstinputlisting{11-interfaz/fecha7/mes.cpp}
\end{block}
\end{frame}
...
\begin{frame}
\begin{block}{fecha.h}
\lstinputlisting[lastline=19]{11-interfaz/fecha7/fecha.h}
\end{block}
\end{frame}

\begin{frame}
\begin{block}{fecha.h}
\lstinputlisting[firstline=21]{11-interfaz/fecha7/fecha.h}
\end{block}
\end{frame}
...
\begin{frame}
\begin{block}{fecha.h}
\lstinputlisting{11-interfaz/fecha7/fecha.h}
\end{block}
\end{frame}
}
...
\lstinputlisting[lastline=20]{11-interfaz/fecha7/fecha.cpp}
\end{block}
\end{frame}

\begin{frame}
\begin{block}{fecha.cpp}
\lstinputlisting[firstline=22,lastline=36]{11-interfaz/fecha7/fecha.cpp}
\end{block}
\end{frame}

\begin{frame}
\begin{block}{fecha.cpp}
\lstinputlisting[firstline=38]{11-interfaz/fecha7/fecha.cpp}
\end{block}
\end{frame}
...
\begin{frame}
\begin{block}{fecha.cpp}
\lstinputlisting{11-interfaz/fecha7/fecha.cpp}
\end{block}
\end{frame}
}
