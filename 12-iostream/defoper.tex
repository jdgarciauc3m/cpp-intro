...
\lstinputlisting[firstline=33,lastline=34]{12-iostream/fecha/mes.h}
\end{block}
\begin{block}{Tablas de nombres -- mes.cpp}
\lstinputlisting[firstline=15,lastline=23]{12-iostream/fecha/mes.cpp}
\end{block}
\end{frame}
...
\mode<presentation>{
\lstinputlisting[firstline=25,lastline=51,basicstyle=\tiny\ttfamily]{12-iostream/fecha/mes.cpp}
}
\mode<article>{
\lstinputlisting[firstline=25,lastline=51]{12-iostream/fecha/mes.cpp}
}
\end{block}
\end{frame}
...
\lstinputlisting[firstline=44,lastline=62,basicstyle=\tiny\ttfamily]{12-iostream/fecha/fecha.cpp}
\end{block}
\end{frame}
