...
\lstinputlisting[lastline=21]{12-iostream/filtro/main.cpp}
\ldots
\end{block}
\end{frame}
...
\begin{block}{main.cpp}
\ldots
\lstinputlisting[firstline=23]{12-iostream/filtro/main.cpp}
\end{block}
\end{frame}
...
\begin{frame}
\begin{block}{main.cpp}
\lstinputlisting{12-iostream/filtro/main.cpp}
\end{block}
\end{frame}
}
...
\begin{frame}
\begin{block}{main.cpp}
\lstinputlisting[lastline=15]{12-iostream/ruta/main.cpp}
\end{block}
\end{frame}

\begin{frame}
\begin{block}{main.cpp}
\lstinputlisting[firstline=17,lastline=30]{12-iostream/ruta/main.cpp}
\end{block}
\end{frame}

\begin{frame}
\begin{block}{main.cpp}
\lstinputlisting[firstline=31,lastline=43]{12-iostream/ruta/main.cpp}
\end{block}
\end{frame}

\begin{frame}
\begin{block}{main.cpp}
\lstinputlisting[firstline=45]{12-iostream/ruta/main.cpp}
\end{block}
\end{frame}
...
\begin{frame}
\begin{block}{main.cpp}
\lstinputlisting{12-iostream/ruta/main.cpp}
\end{block}
\end{frame}
}
