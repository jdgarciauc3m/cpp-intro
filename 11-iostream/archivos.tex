...
\lstinputlisting[lastline=21]{11-iostream/filtro/main.cpp}
\ldots
\end{block}
\end{frame}
...
\begin{block}{main.cpp}
\ldots
\lstinputlisting[firstline=23]{11-iostream/filtro/main.cpp}
\end{block}
\end{frame}
...
\begin{frame}
\begin{block}{main.cpp}
\lstinputlisting{11-iostream/filtro/main.cpp}
\end{block}
\end{frame}
}
...
\begin{frame}
\begin{block}{main.cpp}
\lstinputlisting[lastline=15]{11-iostream/ruta/main.cpp}
\end{block}
\end{frame}

\begin{frame}
\begin{block}{main.cpp}
\lstinputlisting[firstline=17,lastline=30]{11-iostream/ruta/main.cpp}
\end{block}
\end{frame}

\begin{frame}
\begin{block}{main.cpp}
\lstinputlisting[firstline=31,lastline=43]{11-iostream/ruta/main.cpp}
\end{block}
\end{frame}

\begin{frame}
\begin{block}{main.cpp}
\lstinputlisting[firstline=45]{11-iostream/ruta/main.cpp}
\end{block}
\end{frame}
...
\begin{frame}
\begin{block}{main.cpp}
\lstinputlisting{11-iostream/ruta/main.cpp}
\end{block}
\end{frame}
}
