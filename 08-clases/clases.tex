...
\vspace{-.8em}
\begin{block}{fecha.h}
\lstinputlisting{08-clases/fecha1/fecha.h}
\end{block}
\begin{block}{main.cpp}
\lstinputlisting[firstline=6]{08-clases/fecha1/main.cpp}
\end{block}
\end{frame}
...
\mode<presentation>{
\lstinputlisting[lastline=18]{08-clases/fecha1/fecha.cpp}
}
\mode<article>{
\lstinputlisting{08-clases/fecha1/fecha.cpp}
}
\end{block}
\end{frame}
...
\begin{block}{fecha.h}
\lstinputlisting{08-clases/fecha2/fecha.h}
\end{block}
\begin{block}{main.cpp}
\lstinputlisting[firstline=6]{08-clases/fecha2/main.cpp}
\end{block}
\end{frame}
...
\begin{block}{fecha.cpp}
\mode<presentation>{
\lstinputlisting[lastline=18]{08-clases/fecha2/fecha.cpp}
}
\mode<article>{
\lstinputlisting{08-clases/fecha2/fecha.cpp}
}
\end{block}
\end{frame}
...
\begin{block}{fecha.h}
\lstinputlisting{08-clases/fecha3/fecha.h}
\end{block}
\end{frame}

\begin{frame}
\begin{block}{main.cpp}
\lstinputlisting{08-clases/fecha3/main.cpp}
\end{block}
\end{frame}

\begin{frame}
\begin{block}{fecha.cpp}
\lstinputlisting[lastline=19]{08-clases/fecha3/fecha.cpp}
\end{block}
\end{frame}

\begin{frame}
\begin{block}{fecha.cpp}
\lstinputlisting[firstline=21,lastline=39]{08-clases/fecha3/fecha.cpp}
\end{block}
\end{frame}

\begin{frame}
\begin{block}{fecha.cpp}
\lstinputlisting[firstline=40,lastline=47]{08-clases/fecha3/fecha.cpp}
\end{block}
\end{frame}

\begin{frame}
\begin{block}{fecha.cpp}
\lstinputlisting[firstline=49]{08-clases/fecha3/fecha.cpp}
\end{block}
\end{frame}
...
\begin{block}{fecha.h}
\lstinputlisting{08-clases/fecha4/fecha.h}
\end{block}
\end{frame}

\begin{frame}
\begin{block}{fecha.cpp}
\lstinputlisting[lastline=10]{08-clases/fecha4/fecha.cpp}
\end{block}
\end{frame}

\begin{frame}
\begin{block}{main.cpp}
\lstinputlisting{08-clases/fecha4/main.cpp}
\end{block}
\end{frame}
