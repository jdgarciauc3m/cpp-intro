...
\lstinputlisting{05-alcance/decl/main1.cpp}
    \begin{itemize}
      \item 5 errores:
        \begin{itemize}
...
\lstinputlisting{05-alcance/decl/main2.cpp}
\begin{itemize}
...
\lstinputlisting{05-alcance/decl/main3.cpp}
\begin{itemize}
  \item Cambios:
    \begin{itemize}
...
\begin{frame}{Ejemplo}
\begin{block}{geom.h}
\lstinputlisting{05-alcance/cab/geom.h}
\end{block}
\begin{block}{geom.cpp}
\lstinputlisting{05-alcance/cab/geom.cpp}
\end{block}
\end{frame}

\begin{frame}
\begin{block}{main.cpp}
\lstinputlisting{05-alcance/cab/main.cpp}
\end{block}
\end{frame}
