...
void fecha::imprime() {
  using namespace std;
  cout << dia << "/" << static_cast<int>(mes) << "/" << anyo << endl;
}
...
int dias_de_mes(mes_id m, int a) {
    switch (m) {
      case mes_id::enero: case mes_id::marzo: case mes_id::mayo: 
      case mes_id::julio: case mes_id::agosto: case mes_id::octubre: 
      case mes_id::diciembre:
        return 31;
      case mes_id::abril: case mes_id::junio: case mes_id::septiembre: 
