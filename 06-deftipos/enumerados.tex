...
\begin{frame}
\begin{block}{fecha.h}
\lstinputlisting[lastline=12]{06-deftipos/fecha5/fecha.h}
\end{block}
\end{frame}

\begin{frame}
\begin{block}{fecha.h}
\lstinputlisting[firstline=14]{06-deftipos/fecha5/fecha.h}
\end{block}
\end{frame}

\begin{frame}
\begin{block}{main.cpp}
\lstinputlisting{06-deftipos/fecha5/main.cpp}
\end{block}
\end{frame}

\begin{frame}
\begin{block}{fecha.cpp}
\lstinputlisting[lastline=20]{06-deftipos/fecha5/fecha.cpp}
\end{block}
\end{frame}

\begin{frame}
\begin{block}{fecha.cpp}
\lstinputlisting[firstline=22, lastline=39]{06-deftipos/fecha5/fecha.cpp}
\end{block}
\end{frame}

\begin{frame}
\begin{block}{fecha.cpp}
\lstinputlisting[firstline=41, lastline=48]{06-deftipos/fecha5/fecha.cpp}
\end{block}
\end{frame}

\begin{frame}
\begin{block}{fecha.cpp}
\lstinputlisting[firstline=50]{06-deftipos/fecha5/fecha.cpp}
\end{block}
\end{frame}
