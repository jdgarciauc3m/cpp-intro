...
\lstinputlisting{ejemplos/hola/hola.cpp}
\end{block}
...
\ldots
\mode<presentation>{
\lstinputlisting[language={[x86masm]Assembler},basicstyle=\tiny\ttfamily,firstline=10,lastline=28]{ejemplos/hola/hola.s}
}
\mode<article>{
\lstinputlisting[language={[x86masm]Assembler},basicstyle=\ttfamily,firstline=10,lastline=28]{ejemplos/hola/hola.s}
}
\ldots
\end{block}
\end{frame}
...
\lstinputlisting[style=terminal,basicstyle=\tiny\ttfamily]{ejemplos/hola/hola.nm}
\end{block}
\end{frame}

\begin{frame}{Símbolos con nombres descrifrados}
\begin{block}{nm hola.o | c++filt}
\lstinputlisting[style=terminal,basicstyle=\tiny\ttfamily]{ejemplos/hola/hola.nm.cpp}
\end{block}
\end{frame}
